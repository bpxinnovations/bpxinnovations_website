  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 className="font-bold text-5xl md:text-7xl bg-gradient-to-r font-bricolage from-base-content from-50% to-[#9c9c9c] text-center bg-clip-text text-transparent !leading-[1.25em] mb-5">
            {locale.h1}
          </h1>
        </motion.div>
        ...
        >
          ...
          <div className="w-full md:w-8/12 mx-auto flex flex-col md:flex-row md:items-center justify-between gap-y-5">
            ...
            <div className="flex flex-col md:flex-row gap-2 ml-5">
              ...
              >
                <FaUsersViewfinder className="w-5 h-5" />
              ...
              >
                <RiSearchEyeLine className="w-5 h-5" /> Explore Services
              </a>
            </div>
          </div>
        </motion.div>
        ...
        >
          {/* <Image
            ...
            className="hidden md:flex w-full -mt-10 rounded-lg"
            alt="app demo"
          /> */}
